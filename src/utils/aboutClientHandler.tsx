...
const btnClasses = 'customer-details p-0 text-truncate overflow-hidden text-nowrap w-100 text-start';

export const aboutClientHandler = (cell: string, row: OrderListResponse) =>
  <Button
    as={Link as any}
    className={row.userArchivedOn === null ? `${btnClasses}`:
      `${btnClasses} button-disabled-style`}
