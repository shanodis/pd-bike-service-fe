...
const AboutCustomerForm: FC<AboutCustomerFormProps> = ({
  ...
  return (
    <Form>
      ...
      <UserForm readonlyMode={!switchToEditMode} disableMailInput hideCheckboxInput />

      <Row className="mt-5 mb-3 justify-content-between">
        <Col xs={4} sm={5} md={7} lg={9} className="text-start">
          <Button variant="danger" onClick={() => setShowDeleteModal(true)}>
            {t('customerDetails.deleteButton')}
          </Button>
        </Col>
